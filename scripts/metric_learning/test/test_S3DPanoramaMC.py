...
from s3d import *
from scripts.metric_learning.s3d_dataset import S3DPanoramaMC
from scripts.utils.visualize_occ import visualize_occ # 可视化占用网格
from assets.semantic2label import LABEL_TO_COLOR

if __name__ == "__main__":

    test_csv_pth = os.path.join(s3d_csv_pth, "matching_train.csv")
    test_dataset = S3DPanoramaMC(test_csv_pth)
