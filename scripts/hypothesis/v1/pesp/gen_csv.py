...
def generate_scene_csv(scene_index):
    ...
    # 保存到 csv 文件
    scene_output_pth = os.path.join(s3d_csv_pth, scene_index, f"hypothesis_v1/{scene_index}_pesp.csv")
    os.makedirs(os.path.join(s3d_csv_pth, scene_index, "hypothesis_v1"), exist_ok=True)
